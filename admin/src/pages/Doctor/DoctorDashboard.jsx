  ...
  return dashData && (
    <div className='w-full max-w-7xl mx-auto p-6'>
      ...
      <div className='mb-8'>
        ...
        <p className='text-gray-600 mt-1'>Welcome to your doctor dashboard</p>
      </div>
        ...
        <div className='bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow'>
          <div className='flex items-center gap-4'>
            <div className='w-12 h-12 rounded-lg bg-green-50 flex items-center justify-center'>
              <img className='w-7 h-7' src={assets.earning_icon} alt="Earnings" />
            </div>
            <div>
          ...
          <div className='mt-4 pt-4 border-t border-gray-100'>
            <div className='flex items-center justify-between text-sm'>
              ...
              <span className='font-medium text-gray-900'>{currency} {dashData.earnings}</span>
            </div>
          </div>
        </div>
      ...
      <div className='bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden'>
        ...
        {dashData.latestAppointments.length === 0 && (
          <div className='py-12 text-center'>
            ...
            <p className='text-gray-500'>You don't have any recent appointments.</p>
          </div>
        )}
      </div>
    </div>
